...
// Pemakaian per bulan (6 bulan terakhir)
$pemakaianBulan = [];
$pemakaianLabels = [];
for ($i = 5; $i >= 0; $i--) {
...
$pemakaianLabels[] = $bulanList[(int)$bulan - 1];
...
<div class="card" style="margin-bottom: 24px; padding: 24px;">
    <h4 style="font-size: 16px; font-weight: 600; margin-bottom: 20px; color: var(--text-main);">Pemakaian Air Per Bulan</h4>
